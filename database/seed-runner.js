...
// Reusable seed logic, callable either from the CLI script (database/seed.js)
// or from a running server (a one-time remote-seed endpoint). Does not
// close the pool -- the caller owns that decision.
module.exports = async function runSeed(db) {
  ...
  try {
    ...
    return 'Fabric ERP demo data seeded successfully.';
  } catch (e) {
